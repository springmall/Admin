<template>
  <div class="flex text-gray-800 h-12 items-center bg-gray-50">
    <MenuSearch></MenuSearch>
    <div></div>
    <div class="flex flex-row-reverse flex-grow items-center pr-4">
      <a
      ...
      >
        ...
        >
          <div
            ...
            "
          >
            <font-awesome-icon class="w-5" icon="user" /> Profile
          </div>
          <div
            class="px-5 py-2 cursor-pointer hover:bg-blue-600"
            @click="
            ...
            "
          >
            <font-awesome-icon class="w-5" icon="message" /> Message
          </div>
          <div
            class="px-5 py-2 cursor-pointer hover:bg-blue-600"
            @click="
            ...
            "
          >
            <font-awesome-icon class="w-5" icon="gear" /> Setting
          </div>
          <div
            class="px-5 py-2 cursor-pointer hover:bg-blue-600"
            @click="
